...
<html>
	...
	<body>
		<?php
			...
			echo "Today, I went to the " . $place . " to buy a " . $attribute . " " . $noun .".
			When I got there, a ". $animal . " suddenly " . $verb . " past me!
			Everyone started " . $verb2 . ", and I couldn’t stop " . $verb2 . " too."
		?>
		...
		<p>
			Today, I went to the <?=$place?> to buy a <?=$attribute?> <?=$noun?>.
			When I got there, a <?=$animal?> suddenly <?=$verb?> past me!
			Everyone started <?=$verb2?>, and I couldn’t stop <?=$verb2?> too.
		</p>
